    ...
    <>
      ...
      <AppBar position="fixed" sx={{ backgroundColor: '#000', boxShadow: 'none' }}>
        <Toolbar>
          ...
          {/* Các nút điều hướng */}
          <Button color="inherit" sx={{ marginLeft: '40px' }}>Trang chủ</Button>
          <Button color="inherit" sx={{ marginLeft: '40px' }}>Giới thiệu</Button>
          <Button color="inherit" sx={{ marginLeft: '40px' }}>Liên hệ</Button>
        </Toolbar>
      </AppBar>
      {/* Nội dung trang */}
      <Box
